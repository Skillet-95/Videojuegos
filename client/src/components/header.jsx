...
class Header extends Component {
  ...
  getApi = async () => {
  fetch('`/api/topRatedRecommended')
    .then(res => res.json())
    .then((data) => {
      console.log(this.state.data)
      this.setState({ data: data, dataIsReady: true })
    })
    .catch(console.log)
  }
  ...
  render ()  {
    const imagePlacement = this.state.dataIsReady
      ? 'linear-gradient(0deg, rgba(52,58,64,1) 0%, rgba(52,58,64,0) 100%), url(' +  this.getApi()  + ')'
      : 'url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)'
        ...
        return (
          ...
          <nav 
            ...
            style={{  
              backgroundImage: "linear-gradient(0deg, rgba(52,58,64,1) 0%, rgba(52,58,64,0) 100%), url(" + "https://media.rawg.io/media/games/562/562553814dd54e001a541e4ee83a591c.jpg" + ")",
